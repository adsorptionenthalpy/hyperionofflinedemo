...
import styles from "./FIOGameUXUsersSubmit.module.css";

const FIOGameUXUsersSubmit: FunctionComponent = () => {
  return (
    <div className={styles.fioGameuxUsersSubmit}>
      <img
        className={styles.adobestock6152461491Icon}
        alt=""
        src="/adobestock-615246149-1@2x.png"
      />
      <div className={styles.fioGameuxUsersSubmitChild} />
...
export default FIOGameUXUsersSubmit;
